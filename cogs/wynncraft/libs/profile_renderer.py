...
def generate_profile_card(info, output_path="profile_card.png", skin_image=None):
    ...
    if top_ranks:
        for i, rank_data in enumerate(top_ranks):
            ...
            draw.text((360 - (bbox[2] - bbox[0]), y_pos + 40), rank_str, font=font_tiny, fill=(60, 40, 30, 255))
    else:
    ...
    draw.text((690, 1400), "Generated by", font=font_mini, fill=(60,40,30,255))
    draw.text((725, 1430), "AtamaWaruiBoi", font=font_mini, fill=(60,40,30,255))
    draw.text((900, 1460), "#3244", font=font_mini, fill=(60,40,30,255))
