...
def generate_profile_card(info, output_path="profile_card.png", skin_image=None):
    ...
    if uuid and '-' in uuid:
        ...
        line1 = line2 = ""
    draw.text((475, 1370), "UUID", font=font_raids, fill=(90,90,90,255))
    draw.text((600, 1375), line1 + "-", font=font_uuid, fill=(90,90,90,255))
    draw.text((475, 1415), line2, font=font_uuid, fill=(90,90,90,255))

    draw.text((635, 1490), "Generated by", font=font_mini, fill=(60,40,30,255))
    draw.text((735, 1525), "AtamaWaruiBoi#3244", font=font_mini, fill=(60,40,30,255))
