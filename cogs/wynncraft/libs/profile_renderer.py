...
BASE_IMG_PATH = os.path.join(PROJECT_ROOT, "assets/wynncraft/player_profile/profile_card.png")
PLAYER_BACKGROUND_PATH = os.path.join(PROJECT_ROOT, "assets/wynncraft/player_profile/IMG_1493.png")
...
RANK_ICON_MAP = {
    "Champion": os.path.join(PROJECT_ROOT, "assets/wynncraft/player_profile/champ_icon.png"),
    "Hero+": os.path.join(PROJECT_ROOT, "assets/wynncraft/player_profile/heroplus_icon.png"),
    "Hero": os.path.join(PROJECT_ROOT, "assets/wynncraft/player_profile/hero_icon.png"),
    "Vip+": os.path.join(PROJECT_ROOT, "assets/wynncraft/player_profile/vipplus_icon.png"),
    "Vip": os.path.join(PROJECT_ROOT, "assets/wynncraft/player_profile/vip_icon.png"),
}
RANK_COLOR_MAP = {
