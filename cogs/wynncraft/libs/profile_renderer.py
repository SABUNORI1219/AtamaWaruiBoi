...
def generate_profile_card(info, output_path="profile_card.png", skin_image=None):
    ...
    if top_ranks:
        for i, rank_data in enumerate(top_ranks):
            ...
            draw.text((360 - (bbox[2] - bbox[0]), y_pos + 30), rank_str, font=font_tiny, fill=(60, 40, 30, 255))
    else:
    ...
    login_base_x = 370
    login_base_y = 1180
    draw.text((login_base_x, login_base_y), "Most Logined", font=font_raids, fill=(90, 60, 30, 255))
    draw.text((login_base_x+130, login_base_y+40), "Classes", font=font_raids, fill=(90, 60, 30, 255))
    
    if top_logins:
        for i, login_data in enumerate(top_logins):
            y_pos = login_base_y + 80 + (i * 70)
            ...
            draw.text((680 - (bbox[2] - bbox[0]), y_pos + 30), login_str, font=font_tiny, fill=(60, 40, 30, 255))
    else:
    ...
    if uuid and '-' in uuid:
        ...
        line1 = line2 = ""
    draw.text((690, 1180), "UUID", font=font_mini, fill=(90,90,90,255))
    ...
    draw.text((690, 1370), "Generated by", font=font_mini, fill=(60,40,30,255))
    draw.text((725, 1400), "AtamaWaruiBoi", font=font_mini, fill=(60,40,30,255))
    draw.text((880, 1430), "#3244", font=font_mini, fill=(60,40,30,255))
