...
def generate_profile_card(info, output_path="profile_card.png", skin_image=None):
    ...
    draw.text((login_base_x+80, login_base_y+30), "Classes", font=font_raids, fill=(90, 60, 30, 255))
    ...
    if top_logins:
        for i, login_data in enumerate(top_logins):
            ...
            draw.text((660 - (bbox[2] - bbox[0]), y_pos + 30), login_str, font=font_tiny, fill=(60, 40, 30, 255))
    else:
    ...
    if uuid and '-' in uuid:
        ...
        line1 = line2 = ""
    draw.text((690, 1200), "UUID", font=font_mini, fill=(90,90,90,255))
    ...
    draw.text((690, 1350), "Generated by", font=font_mini, fill=(60,40,30,255))
    draw.text((725, 1380), "AtamaWaruiBoi", font=font_mini, fill=(60,40,30,255))
    draw.text((880, 1410), "#3244", font=font_mini, fill=(60,40,30,255))
